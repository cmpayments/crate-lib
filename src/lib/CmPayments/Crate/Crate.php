...
use CmPayments\Crate\Exception\FileException;
use CmPayments\Crate\Exception\InvalidArgumentException;
use CmPayments\Crate\Exception\OpenSslException;
use CmPayments\Crate\Exception\UnexpectedValueException;
use Phar;
use Phine\Path\Path;
