...
class Extract
{
     ...
     * @var string
     */
    const PATTERN_DEFAULT = CRATE_EXTRACT_PATTERN_DEFAULT;
     ...
     * @var string
     */
    const PATTERN_OPEN = CRATE_EXTRACT_PATTERN_OPEN;
     ...
     *
     * The stub generated included with the Crate library uses what I like
     ...
     * default stub is slightly different than the one used by Crate. This
