...
namespace CmPayments\Crate\Tests\Signature;

use CmPayments\Crate\Signature\PublicKeyDelegate;
    ...
    public function testConstruct()
    {
        ...
        if (extension_loaded('openssl')) {
            ...
            $this->assertInstanceOf(
                'CmPayments\\Crate\\Signature\\OpenSsl',
                $this->getPropertyValue($hash, 'hash')
            );
        } else {
            $this->assertInstanceOf(
                'CmPayments\\Crate\\Signature\\PhpSecLib',
                $this->getPropertyValue($hash, 'hash')
            );
        }
    }
